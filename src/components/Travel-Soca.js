...
class TravelSoca extends Component {
  render () {
    return (
      <STravel>
        Kampiranje u Sloveniji za produženi vikend
        Trajanje  - 6 dana, 20.-25.6.2019. #dolinasoce #slovenia #roadtrip #riversoca
        <SText>
        ...
        <SText>
          Subota 22.6.2019.
          U subotu nas je dočekala kiša te smo odlučili prepustiti se vremenskim prilikama i prvi dio dana provesti pod šatorom. Nismo očajavali. Dapače odmor na odmoru je dobro došao, a i sve je stvar perspektive. Tako smo pretvorili to u pozitivno iskustvu. Izguglali možemo li kuhati kavu u šatoru, jer kava je ipak najvažnija. Ostatak nam  je dana u šatoru bilo uživanje u trenutku.
            Slap Kozjak
          Popodne nam je ipak dozvolilo skitanje pa smo se odlučili za vožnju do Kobarida. Tamo smo otišli do slapa Kozjak koji se nalazi na rubu Triglavskog Nacionalnog Parka. Šetnja traje ukupno oko 1h i 15minuta. Kao i na ostalim dijelovima na kojima smo bili, šetnica je jako uređena, pogled na svakom koraku ostavlja bez daha, a slapu se možeš samo diviti.
            Most Napoleona
        ...
        <SText>
          ...
          Ponedjeljak je bio još jedan putni dan, gdje smo odlučili isprobati kako je to SUP-ati. Rezervirali smo 2 SUP-a za 15h u Soča SUP-u kod Mosta na Soči (rezervacija se obavlja telefonski), a u međuvremenu smo obišli obližnje pripremljene zvjezdice.
            Tolminska korita
          Tolminska korita su još jedna posebna priča, još jedna slična, a posebna šetnica i još jedan pogled u ljepotu oko sebe. Uz korita je besplatan parking, iako dosta popunjen, ulaznica je 5 eura, a šetnja od otprilike sat vremena puna prizora za prepričavanje. Čak je moguće piti vodu direktno iz stijena. Što se ne sjećamo kada smo zadnji put to napravili. Osjećaj je super, a voda osvježavajuća.
            Ušče rijeke Tolminke u Soču
